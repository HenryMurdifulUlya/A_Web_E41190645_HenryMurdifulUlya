<!-- ======= Header ======= -->
 <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="{{ asset('frontend/assets/index.html" class="logo mr-auto"><img src="assets/img/logo.png')}}" alt="" class="img-fluid"></a>
...
[20:06, 4/6/2021] +62 812-1672-9887: @extends('frontend/layouts.template')
